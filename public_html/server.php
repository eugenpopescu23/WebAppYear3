...
$msg = "";
   ...
   //get all submited data from the form
    ...
    $cost = $_POST['cost'];
        //errors
    if (empty($startingpoint)) { array_push($errors, "Starting Point is required"); } 
    if (empty($destination)) { array_push($errors, "Destination is required"); } 
    if (empty($time)) { array_push($errors, "Time is required"); }
    if (empty($days)) { array_push($errors, "Days are required"); }
    if (empty($provide)) { array_push($errors, "Option is required"); }
    if (empty($car)) { array_push($errors, "Type of Car is required"); }
